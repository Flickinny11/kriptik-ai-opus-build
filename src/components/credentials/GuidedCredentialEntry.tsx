...
export const PLATFORM_GUIDES: Record<string, PlatformGuide> = {
    ...
    steps: [
      {
        ...
        description: 'Click to open RunPod. Sign up or log in to your account.',
        action: 'link',
      ...
      },
      {
        ...
        description: 'Go to Settings → API Keys in the left sidebar.',
      },
      {
        title: 'Create API Key',
        description: 'Click "Create API Key", give it a name, and copy the generated key.',
      },
      {
        title: 'Enter API Key',
        description: 'Paste your RunPod API key here',
        action: 'input',
        inputName: 'RUNPOD_API_KEY',
        inputPlaceholder: 'rp_...',
      },
    ],
  },
  'modal': {
  ...
  'docker': {
    ...
    consoleName: 'Docker Hub Settings',
    consoleUrl: 'https://hub.docker.com/settings/security',
    iconColor: '#2496ED',
    envVars: ['DOCKER_USERNAME', 'DOCKER_ACCESS_TOKEN'],
    steps: [
      {
        title: 'Open Docker Hub Security Settings',
        description: 'Click to open Docker Hub security settings.',
        action: 'link',
        linkUrl: 'https://hub.docker.com/settings/security',
        linkText: 'Open Docker Hub Settings',
      },
      {
        title: 'Create Access Token',
        description: 'Click "New Access Token", give it a name, and select "Read & Write" permissions.',
      },
      {
        title: 'Enter Docker Username',
      ...
      {
        title: 'Enter Access Token',
        description: 'Paste your Docker Hub access token here',
        action: 'input',
        inputName: 'DOCKER_ACCESS_TOKEN',
