 ...
 * Signup Page
 *
 * Beautiful dark-themed signup with email/password and social OAuth options.
 * Design inspired by Vercel's signup page.
 */
...
export default function SignupPage() {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        try {
            ...
            toast.success('Account created! Welcome to KripTik AI.');
            navigate('/dashboard');
        } catch (error: any) {
        ...
        <div className="space-y-6">
            ...
            <div className="text-center space-y-2">
                ...
                <p className="text-sm text-zinc-400">
                    ...
                    <Link to="/login" className="text-white hover:text-zinc-300 underline underline-offset-4 transition-colors">
                        Log in
                    </Link>
                </p>
            </div>
